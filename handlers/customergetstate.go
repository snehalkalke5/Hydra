...
func (h *Handler) CustomerGetState(w http.ResponseWriter, r *http.Request) {
	ActionStrg := utils.RequestAbstractGet1(r)
	utils.ResponseAbstract(utils.ExecuteCallGet("components.otrs","components.otrs.apis.customergetstate",ActionStrg),w)
}
